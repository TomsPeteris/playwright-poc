...
import { PartsSearchPage } from '../page-objects/pages/PartsSearchPage';
...
type PageObjects = {
  ...
  partsSearchPage: PartsSearchPage;
};
...
export const test = base.extend<PageObjects>({
  ...
  partsSearchPage: async ({ page }, use) => {
    await use(new PartsSearchPage(page));
  },
});
